...
Now consider we want to store the student number of every individual in Bath Spa University. Using variables alone, we would need over 8000 independent and unique variables! This is unmanageable.
